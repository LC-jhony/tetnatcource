<div class="mb-6 rounded-lg bg-white p-6  dark:bg-zinc-900">
    {{-- <div class="flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div>
                ...
                <span class="block text-xs font-normal text-gray-500">Android
                    Developer</span>
            </div>
        </div>
        <p class="text-sm font-medium text-indigo-500"><span class="mr-0.5">+</span>Follow
        </p>
    </div> --}}
    <div class="grid sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-2">
        {{ $slot }}
    </div>
